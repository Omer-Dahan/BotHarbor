...
class AddProjectDialog(ctk.CTkToplevel):
    ...
    def _setup_ui(self):
        ...
        # Project folder
        ctk.CTkLabel(form, text="Project Folder:").grid(row=0, column=0, padx=5, pady=10, sticky="e")
        ...
        self.python_entry = ctk.CTkEntry(python_frame, placeholder_text="Auto-detected or select...")
