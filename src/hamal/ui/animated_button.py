...
class DepthButton(ctk.CTkLabel):
    ...
    def _generate_image(self, face_color, offset_y=0, is_pressed=False):
        ...
        if self._icon:
            ...
            original_icon = self._icon._dark_image
            if original_icon:
                ...
                icon_img = original_icon.resize((icon_w, icon_h), Image.LANCZOS)
                ...
                icon_img = Image.composite(solid_color, Image.new('RGBA', icon_img.size, (0,0,0,0)), icon_img)
        ...
        # Downscale
        img = img.resize((self._img_width, self._img_height), Image.LANCZOS)
        
        return ctk.CTkImage(light_image=img, dark_image=img, size=(self._img_width, self._img_height))
